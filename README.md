...
The Data Specification on Production and Industrial Facilities – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Production and Industrial Facilities.

The specification specifies the following conformance classes:

| Conformance class | Standardization target |
| ----------------- | ---------------------- |
| [GML application schemas, Production and Industrial Facilities](http://inspire.ec.europa.eu/id/ats/data-pf/3.0/pf-gml) | INSPIRE spatial data set encoded in GML, Production and Industrial Facilities features |
| [Application Schema, Production and Industrial Facilities](http://inspire.ec.europa.eu/id/ats/data-pf/3.0/pf-as) | INSPIRE spatial data set |
| [Reference Systems, Production and Industrial Facilities](http://inspire.ec.europa.eu/id/ats/data-pf/3.0/pf-rs) | INSPIRE spatial data set |
| [Data Consistency, Production and Industrial Facilities](http://inspire.ec.europa.eu/id/ats/data-pf/3.0/pf-dc) | INSPIRE spatial data set |
| [Information Accessibility, Production and Industrial Facilities](http://inspire.ec.europa.eu/id/ats/data-pf/3.0/pf-ia) | INSPIRE spatial data set |
| [Portrayal, Production and Industrial Facilities](http://inspire.ec.europa.eu/id/ats/data-pf/3.0/pf-portrayal) | INSPIRE view service |
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Production and Industrial Facilities - Core", are not needed as no feature instance can be of a type from that application schema.
