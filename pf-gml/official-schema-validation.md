...
* Validate each document against the latest INSPIRE official schema: https://inspire.ec.europa.eu/schemas/pf/4.0/ProductionAndIndustrialFacilities.xsd, using strict XML schema validation.
